...
def get_args(*args):
    ...
    parser.add_argument(
        "--proj_name",
        default="mnist_unbalanced",
        # default="mnist_odd_even",
        help="description of run, for saving stuff",
    )
    parser.add_argument("--precision", default="double", help="")
    parser.add_argument(
        "--run_mode",
        default="train",
        help="options: train, reconstruct",
    ...
    parser.add_argument(
        ...
        default="",
        help="path to pretrained model (ignored if empty)",
    )
    parser.add_argument("--train_save_model", default="true", type=str2bool, help="")
    parser.add_argument(
        "--train_save_model_every", default=-1, type=int, help="only saves if >0"
    )
    parser.add_argument(
        "--extract_save_results", default="true", type=str2bool, help=""
    )
    parser.add_argument(
        "--extract_save_results_every", default=10000, type=int, help="only saves if >0"
    )
    parser.add_argument("--save_args_files", default="true", type=str2bool, help="")

    # wandb
    parser.add_argument(
        "--wandb_active", default="false", type=str2bool, help="actviate wandb logging"
    )
    ...
    # data creation
    parser.add_argument("--problem", default="mnist_unbalanced", help="")
    # parser.add_argument("--problem", default="mnist_odd_even", help="")
    ...
    parser.add_argument(
        "--use_init_scale_only_first", default="true", type=str2bool, help=""
    )
    parser.add_argument(
        "--model_init_list",
        default="[1e-01, 1e-01]",
    ...
    parser.add_argument(
        ...
        default="relu",
        help="options: relu, sigmoid, leakyrelu, tanh",
    )
    ...
    parser.add_argument(
        ...
        default=1e-40,
        type=float,
        help="stop training below this loss",
    )
    ...
    # extraction
    parser.add_argument("--extraction_epochs", default=1000000, type=int, help="")
    parser.add_argument(
        "--extraction_data_amount_per_class", type=int, help="0 = same as data_amount"
    )
    parser.add_argument(
        "--extraction_model_activation",
        default="modifiedrelu",
        help="options: same as model_train_activation",
    )
    parser.add_argument(
        "--extraction_model_relu_alpha", default=300, type=float, help=""
    )
    ...
    parser.add_argument(
        "--extraction_loss_type", default="kkt", help="options: kkt, naive"
    )
